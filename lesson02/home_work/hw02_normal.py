...
new_list = []
for val in list1:
    if val > 0 and sqrt(val) % 1 == 0:
        new_list.append(int(sqrt(val)))
print(new_list)
...
data_word = data_list[0] + ' ' + data_list[1] + ' ' + data_list[2] + ' ' "года"
print(data_word)
...
val = int(input('введите количество случайных элементов в списке: '))
my_list = []
for el in range(val):
